 ...
 */
export const inject = ['slots', 'sessions', 'workspaces', 'locale', 'authorityRegistry']
...
export function apply(ctx: ClientContext): void {
  ...
  const authorityRegistry = ctx.get('authorityRegistry') as WorkspaceBrowserInjected['authorityRegistry']
