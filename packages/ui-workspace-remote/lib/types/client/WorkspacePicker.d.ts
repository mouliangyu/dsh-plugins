...
export interface WorkspacePickFlowProps {
    ...
    /** Registry supplying connected remote authorities. */
 ...
 */
export declare function WorkspacePickFlow({ t, open, anchorRef, useWorkspaces, createWorkspace, authorityRegistry, selectDirectoryAuthority, useDirectoryFlow, renderDirectoryFlow, onPick, onClose, addOnly, side, selectedId, }: WorkspacePickFlowProps): import("react").JSX.Element;
/**
 ...
 */
export declare function WorkspacePicker({ open, anchorRef, useWorkspaces, selectedId, onPick, onClose, createWorkspace, authorityRegistry, selectDirectoryAuthority, useDirectoryFlow, renderSlot, t, }: WorkspacePickerProps): import("react").JSX.Element;
