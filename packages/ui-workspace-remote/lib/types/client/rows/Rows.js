...
export function ProjectRowItem({ group, onToggle, onCreate, actions, drag, t }) {
    ...
    const ownRow = (_jsxs("div", { className: clsx(css.projectRow, menuOpen && css.menuOpen), role: "treeitem", "aria-expanded": row.expanded, onClick: onToggle, draggable: drag !== undefined, onDragStart: drag === undefined
            ...
            : (e) => {
                ...
                drag.start();
            }, onDragEnd: drag?.end, children: [_jsx("span", { className: clsx(css.slot, css.folder, active && css.folderActive), children: row.expanded ? _jsx(IconFolderOpen16, {}) : _jsx(IconFolderClose16, {}) }), _jsx("span", { className: clsx(css.slot, css.chevron), children: _jsx(IconTriangleRightFill14, { className: clsx(css.arrow, row.expanded && css.arrowOpen) }) }), _jsx("span", { className: css.projectText, children: _jsxs("span", { className: css.projectTitleLine, children: [_jsx("span", { className: css.title, children: label }), authority === undefined ? null : _jsx("span", { className: css.authority, children: authority })] }) }), _jsxs("span", { className: css.rowActions, children: [actions !== undefined && (_jsx(Menu, { open: menuOpen, onClose: () => { setMenuOpen(false); }, items: workspaceMenuItems, onSelect: (id) => {
                            setMenuOpen(false);
