window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-client-ui-workspace-remote-css:/Users/mouliangyu/Documents/dsh-plugins/packages/ui-workspace-remote/lib/types/client/rows/Rows.module.css.mjs
		const css$2 = ".WMWOga_projectRow,.WMWOga_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.WMWOga_projectRow:hover,.WMWOga_sessionRow:hover,.WMWOga_sessionRow.WMWOga_selected{background:var(--dsw-alias-interactive-bg-hover)}.WMWOga_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.WMWOga_searchResultRow:hover,.WMWOga_searchResultRow.WMWOga_selected{background:var(--dsw-alias-interactive-bg-hover)}.WMWOga_searchResultHeading{align-items:center;min-width:0;display:flex}.WMWOga_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.WMWOga_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.WMWOga_searchResultWorkspace,.WMWOga_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.WMWOga_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.WMWOga_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.WMWOga_projectRow{box-sizing:border-box;align-items:center;height:34px}.WMWOga_projectRow .WMWOga_rowActions{height:20px}.WMWOga_sessionRow{height:32px;animation:WMWOga_row-in .15s var(--ds-ease-in-out);gap:0}.WMWOga_sessionRow .WMWOga_title{margin:0 6px 0 4px}.WMWOga_flatSessionRowWithoutStatus .WMWOga_title{margin-left:0}@keyframes WMWOga_row-in{0%{opacity:0}}.WMWOga_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.WMWOga_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.WMWOga_folderActive{color:var(--dsw-alias-state-business-primary)}.WMWOga_projectRow .WMWOga_chevron{display:none}.WMWOga_projectRow:hover .WMWOga_chevron{display:inline-flex}.WMWOga_projectRow:hover .WMWOga_folder{display:none}.WMWOga_arrow{transition:transform .15s var(--ds-ease-in-out)}.WMWOga_arrowOpen{transform:rotate(90deg)}.WMWOga_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.WMWOga_projectTitleLine{align-items:baseline;min-width:0;display:flex}.WMWOga_authority{color:var(--text-tertiary,#737b8c);flex:none;margin-left:6px;font-size:11px;line-height:16px}.WMWOga_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.WMWOga_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.WMWOga_sessionRow .WMWOga_title{flex:1}.WMWOga_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.WMWOga_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.WMWOga_dot{flex:none}.WMWOga_rowActions{flex:none;align-items:center;gap:12px;display:none}.WMWOga_projectRow:hover .WMWOga_rowActions,.WMWOga_sessionRow:hover .WMWOga_rowActions,.WMWOga_projectRow.WMWOga_menuOpen .WMWOga_rowActions,.WMWOga_sessionRow.WMWOga_menuOpen .WMWOga_rowActions{display:inline-flex}.WMWOga_sessionRow:hover .WMWOga_time,.WMWOga_sessionRow.WMWOga_menuOpen .WMWOga_time{display:none}.WMWOga_projectRow.WMWOga_menuOpen,.WMWOga_sessionRow.WMWOga_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.WMWOga_sessionRow.WMWOga_dropBefore,.WMWOga_sessionRow.WMWOga_dropAfter{position:relative}.WMWOga_sessionRow.WMWOga_dropBefore:before,.WMWOga_sessionRow.WMWOga_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.WMWOga_sessionRow.WMWOga_dropBefore:before{top:-7px}.WMWOga_sessionRow.WMWOga_dropAfter:after{bottom:-7px}.WMWOga_hoverContent{flex-direction:column;gap:8px;display:flex}.WMWOga_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.WMWOga_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.WMWOga_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.WMWOga_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.WMWOga_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.WMWOga_iconButton:hover{color:var(--dsw-alias-label-primary)}.WMWOga_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.WMWOga_sessionRow,.WMWOga_arrow{transition:none;animation:none}}";
		const tagId$2 = "@deepseek-ai/dsh-client-ui-workspace/Rows.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-client-ui-workspace";
			tag.dataset.pluginCss = tagId$2;
			tag.textContent = css$2;
			document.head.appendChild(tag);
		}
		var Rows_module_css_default = {
			"searchResultTitle": "WMWOga_searchResultTitle",
			"dropAfter": "WMWOga_dropAfter",
			"hoverTime": "WMWOga_hoverTime",
			"slot": "WMWOga_slot",
			"searchResultWorkspace": "WMWOga_searchResultWorkspace",
			"title": "WMWOga_title",
			"folder": "WMWOga_folder",
			"searchResultMeta": "WMWOga_searchResultMeta",
			"row-in": "WMWOga_row-in",
			"selected": "WMWOga_selected",
			"hoverTitle": "WMWOga_hoverTitle",
			"searchResultSnippet": "WMWOga_searchResultSnippet",
			"arrow": "WMWOga_arrow",
			"visuallyHidden": "WMWOga_visuallyHidden",
			"renameInput": "WMWOga_renameInput",
			"time": "WMWOga_time",
			"projectTitleLine": "WMWOga_projectTitleLine",
			"flatSessionRowWithoutStatus": "WMWOga_flatSessionRowWithoutStatus",
			"arrowOpen": "WMWOga_arrowOpen",
			"iconButton": "WMWOga_iconButton",
			"folderActive": "WMWOga_folderActive",
			"dot": "WMWOga_dot",
			"authority": "WMWOga_authority",
			"meta": "WMWOga_meta",
			"hoverPath": "WMWOga_hoverPath",
			"chevron": "WMWOga_chevron",
			"rowActions": "WMWOga_rowActions",
			"menuOpen": "WMWOga_menuOpen",
			"hoverContent": "WMWOga_hoverContent",
			"sessionRow": "WMWOga_sessionRow",
			"dropBefore": "WMWOga_dropBefore",
			"hoverStatus": "WMWOga_hoverStatus",
			"searchResultRow": "WMWOga_searchResultRow",
			"searchResultHeading": "WMWOga_searchResultHeading",
			"projectText": "WMWOga_projectText",
			"projectRow": "WMWOga_projectRow"
		};
		//#endregion
		...
		*/
		function ProjectRowItem({ group, onToggle, onCreate, actions, drag, t }) {
			...
			const authority = row.workspaceId === void 0 ? void 0 : (0, _deepseek_ai_dsh_client_runtime_client.authorityOf)(row.workspaceId);
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("span", {
						...
						children: (0, react_jsx_runtime.jsxs)("span", {
							className: Rows_module_css_default.projectTitleLine,
							children: [(0, react_jsx_runtime.jsx)("span", {
								className: Rows_module_css_default.title,
								children: label
							}), authority === void 0 ? null : (0, react_jsx_runtime.jsx)("span", {
								className: Rows_module_css_default.authority,
								children: authority
							})]
						})
					}),
		...
		*/
		...
		//#endregion
		//#region \0dsh-client-ui-workspace-remote-css:/Users/mouliangyu/Documents/dsh-plugins/packages/ui-workspace-remote/lib/types/client/WorkspacePicker.module.css.mjs
		const css$1 = ".M6dFBq_modalAction{min-width:72px}.M6dFBq_modalError,.M6dFBq_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.M6dFBq_modalError{color:var(--dsw-alias-state-error-primary)}.M6dFBq_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"modalAction": "M6dFBq_modalAction",
			"menuStatus": "M6dFBq_menuStatus",
			"modalError": "M6dFBq_modalError"
		};
		//#endregion
		...
		*/
		function WorkspacePickFlow({ t, open, anchorRef, useWorkspaces, createWorkspace, authorityRegistry, selectDirectoryAuthority, useDirectoryFlow, renderDirectoryFlow, onPick, onClose, addOnly = false, side = "bottom", selectedId }) {
			const workspaceSnapshot = useWorkspaces((state) => state);
			const authoritySnapshot = (0, react.useSyncExternalStore)((listener) => authorityRegistry.subscribe(listener), () => authorityRegistry.getSnapshot());
			...
			const openDirectoryFlow = (0, react.useCallback)((authorityId) => {
			...
			(0, react.useEffect)(() => {
				if (open && addIsTheOnlyEntry && !flowBusy) openDirectoryFlow(void 0);
			}, [
				open,
				addIsTheOnlyEntry,
				flowBusy,
			...
			const handleSelect = (id) => {
				if (id === ADD_LOCAL_WORKSPACE) {
					openDirectoryFlow(void 0);
					return;
				}
				if (id.startsWith(ADD_REMOTE_PREFIX)) {
					openDirectoryFlow(id.slice(23));
					return;
				}
				onPick(id);
			};
		...
		*/
		function WorkspacePicker({ open, anchorRef, useWorkspaces, selectedId, onPick, onClose, createWorkspace, authorityRegistry, selectDirectoryAuthority, useDirectoryFlow, renderSlot, t }) {
		...
		//#endregion
		//#region \0dsh-client-ui-workspace-remote-css:/Users/mouliangyu/Documents/dsh-plugins/packages/ui-workspace-remote/lib/types/client/WorkspaceBrowser.module.css.mjs
		const css = ".XbPW4G_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.XbPW4G_root.XbPW4G_rail{padding-right:0}.XbPW4G_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.XbPW4G_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.XbPW4G_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.XbPW4G_root:not(.XbPW4G_rail) .XbPW4G_sectionHeader{margin-top:2px;margin-right:-4px}.XbPW4G_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.XbPW4G_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.XbPW4G_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.XbPW4G_searchSlotExpanded{max-width:100%;padding-left:0}.XbPW4G_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.XbPW4G_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.XbPW4G_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.XbPW4G_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.XbPW4G_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.XbPW4G_searchExpanded .XbPW4G_searchButton{width:28px;height:30px}.XbPW4G_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.XbPW4G_searchExpanded .XbPW4G_searchButton:hover{background:0 0}.XbPW4G_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.XbPW4G_searchExpanded .XbPW4G_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.XbPW4G_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.XbPW4G_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.XbPW4G_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.XbPW4G_rail .XbPW4G_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.XbPW4G_rail .XbPW4G_headerActions{max-width:none}.XbPW4G_rail .XbPW4G_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.XbPW4G_rail .XbPW4G_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.XbPW4G_rail .XbPW4G_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.XbPW4G_rail .XbPW4G_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.XbPW4G_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.XbPW4G_rail .XbPW4G_listArea{margin-left:0;margin-right:0;padding-left:0}.XbPW4G_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.XbPW4G_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.XbPW4G_wide{animation:XbPW4G_wide-in .2s var(--ds-ease-in-out)}@keyframes XbPW4G_wide-in{0%{opacity:0}}.XbPW4G_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.XbPW4G_flatList>*+*,.XbPW4G_searchTree>[role=treeitem]+[role=treeitem],.XbPW4G_groupSection>*+*{margin-top:2px}.XbPW4G_searchStatus,.XbPW4G_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.XbPW4G_searchWarning{color:var(--dsw-alias-label-secondary)}.XbPW4G_groupSection{position:relative}.XbPW4G_groupSection+.XbPW4G_groupSection{margin-top:4px}.XbPW4G_listTopDropIndicator,.XbPW4G_workspaceDropBefore:before,.XbPW4G_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.XbPW4G_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.XbPW4G_listTopDropActive>.XbPW4G_workspaceDropBefore:first-child:before{display:none}.XbPW4G_workspaceDropBefore:before{top:-8px}.XbPW4G_workspaceDropAfter:after{bottom:-8px}.XbPW4G_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.XbPW4G_groupSection>.XbPW4G_sessionOverflowButton{margin-top:0}.XbPW4G_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.XbPW4G_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.XbPW4G_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.XbPW4G_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.XbPW4G_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.XbPW4G_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.XbPW4G_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.XbPW4G_wide{animation:none}.XbPW4G_search,.XbPW4G_sectionLabel,.XbPW4G_searchSlot,.XbPW4G_searchInput,.XbPW4G_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"wide": "XbPW4G_wide",
			"clearButton": "XbPW4G_clearButton",
			"listTopDropActive": "XbPW4G_listTopDropActive",
			"deleteStatus": "XbPW4G_deleteStatus",
			"rail": "XbPW4G_rail",
			"iconButton": "XbPW4G_iconButton",
			"searchExpanded": "XbPW4G_searchExpanded",
			"listArea": "XbPW4G_listArea",
			"searchInput": "XbPW4G_searchInput",
			"sectionHeader": "XbPW4G_sectionHeader",
			"fade": "XbPW4G_fade",
			"flatList": "XbPW4G_flatList",
			"searchSlot": "XbPW4G_searchSlot",
			"headerActionsHidden": "XbPW4G_headerActionsHidden",
			"searchTree": "XbPW4G_searchTree",
			"empty": "XbPW4G_empty",
			"sectionLabel": "XbPW4G_sectionLabel",
			"search": "XbPW4G_search",
			"deleteAction": "XbPW4G_deleteAction",
			"searchStatus": "XbPW4G_searchStatus",
			"renameError": "XbPW4G_renameError",
			"sectionLabelHidden": "XbPW4G_sectionLabelHidden",
			"workspaceDropBefore": "XbPW4G_workspaceDropBefore",
			"wide-in": "XbPW4G_wide-in",
			"list": "XbPW4G_list",
			"root": "XbPW4G_root",
			"workspaceDropAfter": "XbPW4G_workspaceDropAfter",
			"searchWarning": "XbPW4G_searchWarning",
			"searchButton": "XbPW4G_searchButton",
			"renameInput": "XbPW4G_renameInput",
			"treeBody": "XbPW4G_treeBody",
			"searchSlotExpanded": "XbPW4G_searchSlotExpanded",
			"headerActions": "XbPW4G_headerActions",
			"groupSection": "XbPW4G_groupSection",
			"listTopDropIndicator": "XbPW4G_listTopDropIndicator",
			"sessionOverflowButton": "XbPW4G_sessionOverflowButton"
		};
		//#endregion
		...
		*/
		...
		const zh = {
			...
			"menu.addLocalWorkspace": "添加本地工作区…",
			"menu.addRemoteWorkspace": "在 {remote} 上添加工作区…",
		...
		const en = {
			...
			"menu.addLocalWorkspace": "Add local workspace…",
			"menu.addRemoteWorkspace": "Add workspace on {remote}…",
		...
		*/
		function apply(ctx) {
			...
			const authorityRegistry = ctx.get("authorityRegistry");
			...
			const browserInjected = () => ({
				...
				authorityRegistry,
				selectDirectoryAuthority: (authorityId) => {
					ctx.workspaces.setDirectoryAuthority(authorityId);
				},
