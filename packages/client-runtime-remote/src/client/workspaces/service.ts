...
export class WorkspaceRuntime implements IWorkspaces {
   ...
   */
  constructor(ctx: Context, private readonly api: IApiClient, private readonly sessions: SessionsPort, private readonly router?: AuthorityApiRouter) {
  ...
  setDirectoryAuthority(authorityId?: string): void { this.router?.setDirectoryAuthority(authorityId) }
