...
export interface RemoteProjectView { id: string; root: string }
...
export type RemoteAction =
  ...
  | { action: 'bootstrapHost'; connectionId: string }
  | { action: 'createProject'; connectionId: string; projectId: string; projectRoot: string }
  ...
  | { action: 'projects'; connectionId: string }
  | { action: 'sessions'; connectionId: string; projectId: string }
  | { action: 'createSession'; connectionId: string; projectId: string }
  | { action: 'resumeSession'; connectionId: string; projectId: string; sessionId: string }
  | { action: 'prompt'; connectionId: string; projectId: string; sessionId: string; text: string }
  | { action: 'cancel'; connectionId: string; projectId: string; sessionId: string }
