...
export const en = {
  ...
  refresh: 'Refresh connection', remove: 'Delete', connected: 'Connected', disconnected: 'Disconnected',
...
export const zh: { [K in RemoteLocaleKey]: string } = {
  ...
  save: '保存', cancel: '取消', connect: '连接', disconnect: '断开', refresh: '刷新连接', remove: '删除',
