...
import { type ComposerHistoryConfig } from './client/config.js';
export { Config, resolveConfig } from './client/config.js';
export type { ComposerHistoryConfig } from './client/config.js';
 ...
 */
export declare function apply(ctx: Context, config: ComposerHistoryConfig): void;
