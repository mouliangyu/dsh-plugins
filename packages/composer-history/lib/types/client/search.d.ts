 ...
 */
export declare function filterEntries(entries: readonly string[], query: string, caseSensitive: boolean): string[];
/**
 ...
 * @returns matching entries in their original order.
 */
export declare function filterSearchEntries(entries: readonly SearchEntry[], query: string, caseSensitive: boolean): SearchEntry[];
/**
 ...
 */
export declare function matchRanges(text: string, query: string, caseSensitive: boolean): readonly (readonly [number, number])[];
