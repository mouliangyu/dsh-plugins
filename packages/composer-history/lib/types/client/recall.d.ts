...
export declare const COMPACTION_KIND = "compaction";
/**
 ...
 */
export declare function effectiveKinds(includeKinds: readonly string[], includeCompactionSummaries: boolean): readonly string[];
/**
 ...
 */
export declare function extractHistory(nodes: readonly HistoryNodeView[], options?: Partial<HistoryExtractOptions>): string[];
/**
 ...
 */
export declare function composeHistory(supplemental: readonly string[], current: readonly string[]): string[];
 ...
 */
export declare function hasActiveTriggerToken(draft: string, caret: number): boolean;
/** Logical ↑ edge: the caret sits on the first line (or the draft has one line). */
export declare function upAtLogicalEdge(draft: string, caret: number): boolean;
/** Logical ↓ edge: the caret sits on the last line. */
export declare function downAtLogicalEdge(draft: string, caret: number): boolean;
/**
 ...
 */
export declare class DraftRecall {
